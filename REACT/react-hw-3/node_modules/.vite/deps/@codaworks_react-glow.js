...
// node_modules/@codaworks/react-glow/dist/react-glow.cjs.development.js
var require_react_glow_cjs_development = __commonJS({
  "node_modules/@codaworks/react-glow/dist/react-glow.cjs.development.js"(exports) {
    "use client";
    "use strict";
    ...
    var _excluded2 = ["className", "style", "children", "color", "debug"];
    var GlowCapture = function GlowCapture2(props) {
      var _props$className = props.className, className = _props$className === void 0 ? "" : _props$className, _props$size = props.size, size = _props$size === void 0 ? 400 : _props$size, rest = _objectWithoutPropertiesLoose(props, _excluded);
      var element = React.useRef(null);
      React.useEffect(function() {
        var _element$current3, _element$current4;
        var move = function move2(e) {
    ...
    var Glow = function Glow2(props) {
      var _props$className2 = props.className, className = _props$className2 === void 0 ? "" : _props$className2, style = props.style, children = props.children, _props$color = props.color, color = _props$color === void 0 ? "#f50057" : _props$color, _props$debug = props.debug, debug = _props$debug === void 0 ? false : _props$debug, rest = _objectWithoutPropertiesLoose(props, _excluded2);
      var element = React.useRef(null);
      React.useEffect(function() {
...
// node_modules/@codaworks/react-glow/dist/index.js
var require_dist = __commonJS({
  "node_modules/@codaworks/react-glow/dist/index.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_react_glow_cjs_development();
    }
  }
});
export default require_dist();
//# sourceMappingURL=@codaworks_react-glow.js.map
